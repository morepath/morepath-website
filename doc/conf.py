...
project = u'Morepath'
copyright = u'2015, Morepath developers'
...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ("Documentation", "http://morepath.readthedocs.org", True),
        ("Community", "community"),
